...
class Base64File implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['base64']) < 1)) {
            $invalidProperties[] = "invalid value for 'base64', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setBase64($base64)
    {
        ...
        if ((mb_strlen($base64) < 1)) {
            throw new \InvalidArgumentException('invalid length for $base64 when calling Base64File., must be bigger than or equal to 1.');
        }
