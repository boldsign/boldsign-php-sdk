...
/**
 * CreateSenderIdentityRequest Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class CreateSenderIdentityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSenderIdentityRequest';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 250)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateSenderIdentityRequest., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateSenderIdentityRequest., must be bigger than or equal to 0.');
        }
