    ...
    */
    ...
    public function setTeamName($team_name)
    {
        ...
        if ((mb_strlen($team_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $team_name when calling CreateTeamRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($team_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $team_name when calling CreateTeamRequest., must be bigger than or equal to 0.');
        }
