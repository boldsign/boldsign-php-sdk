 ...
 */
class DocumentCC implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentCC';
    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling DocumentCC., must be bigger than or equal to 1.');
        }
