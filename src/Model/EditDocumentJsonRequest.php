...
/**
 * EditDocumentJsonRequest Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class EditDocumentJsonRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditDocumentJsonRequest';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 256)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EditDocumentJsonRequest., must be smaller than or equal to 256.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EditDocumentJsonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if (!is_null($message) && (mb_strlen($message) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $message when calling EditDocumentJsonRequest., must be smaller than or equal to 5000.');
        }
        if (!is_null($message) && (mb_strlen($message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $message when calling EditDocumentJsonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDownloadFileName($download_file_name)
    {
        ...
        if (!is_null($download_file_name) && (mb_strlen($download_file_name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $download_file_name when calling EditDocumentJsonRequest., must be smaller than or equal to 250.');
        }
        if (!is_null($download_file_name) && (mb_strlen($download_file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $download_file_name when calling EditDocumentJsonRequest., must be bigger than or equal to 0.');
        }
