...
/**
 * GroupContactDetails Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class GroupContactDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupContactDetails';
    ...
    */
    ...
    public function setGroupName($group_name)
    {
        ...
        if ((mb_strlen($group_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling GroupContactDetails., must be bigger than or equal to 1.');
        }
     ...
     * Gets contacts
     *
     * @return \BoldSign\Model\GroupUser[]
     */
     ...
     * Sets contacts
     *
     * @param \BoldSign\Model\GroupUser[] $contacts contacts
     *
     * @return self
     */
