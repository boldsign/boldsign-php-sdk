...
class Rectangle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('height', $data ?? [], 1);
    }
    ...
    */
    ...
    public function setX($x)
    {
        ...
        if (($x < 0)) {
            throw new \InvalidArgumentException('invalid value for $x when calling Rectangle., must be bigger than or equal to 0.');
        }
    ...
    public function setY($y)
    {
        ...
        if (($y < 0)) {
            throw new \InvalidArgumentException('invalid value for $y when calling Rectangle., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling Rectangle., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling Rectangle., must be bigger than or equal to 1.');
        }
