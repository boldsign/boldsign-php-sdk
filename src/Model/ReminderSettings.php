...
class ReminderSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('enable_auto_reminder', $data ?? [], false);
        $this->setIfExists('reminder_days', $data ?? [], 3);
        $this->setIfExists('reminder_count', $data ?? [], 3);
    }
    ...
    */
    ...
    public function setEnableAutoReminder($enable_auto_reminder)
    {
        if (is_null($enable_auto_reminder)) {
            throw new \InvalidArgumentException('non-nullable enable_auto_reminder cannot be null');
        }
    ...
    public function setReminderCount($reminder_count)
    {
        if (is_null($reminder_count)) {
            throw new \InvalidArgumentException('non-nullable reminder_count cannot be null');
        }
