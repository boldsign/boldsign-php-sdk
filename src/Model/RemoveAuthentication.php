...
/**
 * RemoveAuthentication Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class RemoveAuthentication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveAuthentication';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('z_order', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['z_order'];
    }

    /**
     * Sets z_order
     *
     * @param int|null $z_order z_order
     *
     * @return self
     */
    ...
    {
        if (is_null($z_order)) {
            array_push($this->openAPINullablesSetToNull, 'z_order');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('z_order', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['z_order'] = $z_order;
