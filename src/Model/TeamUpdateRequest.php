...
class TeamUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['team_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'team_id', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['team_name'] === null) {
            $invalidProperties[] = "'team_name' can't be null";
        }
        if ((mb_strlen($this->container['team_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'team_name', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['team_name']) < 0)) {
    ...
    public function setTeamId($team_id)
    {
        ...
        if ((mb_strlen($team_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team_id when calling TeamUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTeamName($team_name)
    {
        ...
        if ((mb_strlen($team_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $team_name when calling TeamUpdateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($team_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $team_name when calling TeamUpdateRequest., must be bigger than or equal to 0.');
        }
