...
class TeamUsers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TeamUsers';
    ...
    public const USER_ROLE_ACCOUNT_ADMIN = 'AccountAdmin';
    public const USER_ROLE_TEAM_ADMIN = 'TeamAdmin';
    public const USER_ROLE_TEAM_MEMBER = 'TeamMember';
    public const USER_STATUS_ACTIVE = 'Active';
    public const USER_STATUS_INVITATION_PENDING = 'InvitationPending';
    ...
    {
        return [
            self::USER_ROLE_ACCOUNT_ADMIN,
            self::USER_ROLE_TEAM_ADMIN,
            self::USER_ROLE_TEAM_MEMBER,
        ];
    }
    ...
    public function getUserStatusAllowableValues()
    {
        return [
            ...
            self::USER_STATUS_INVITATION_PENDING,
