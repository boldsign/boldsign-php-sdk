 ...
 */
class TemplateTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'document_labels' => 'setDocumentLabels',
    ...
    protected static $getters = [
        ...
        'document_labels' => 'getDocumentLabels',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('document_labels', $data ?? [], null);
    ...
    */
    ...
    public function setTemplateId($template_id)
    {
        ...
        if ((mb_strlen($template_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $template_id when calling TemplateTag., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets document_labels
     *
     * @return string[]|null
     */
    public function getDocumentLabels()
    {
        return $this->container['document_labels'];
    }

    /**
     * Sets document_labels
     *
     * @param string[]|null $document_labels document_labels
     *
     * @return self
     */
    public function setDocumentLabels($document_labels)
    {
        if (is_null($document_labels)) {
            array_push($this->openAPINullablesSetToNull, 'document_labels');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('document_labels', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['document_labels'] = $document_labels;
