...
/**
 * TemplateTeamShareRequest Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class TemplateTeamShareRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateTeamShareRequest';
    ...
    public const ACCESS_LEVEL__USE = 'Use';
    ...
    */
    ...
    public function setTeamId($team_id)
    {
        ...
        if ((mb_strlen($team_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team_id when calling TemplateTeamShareRequest., must be bigger than or equal to 1.');
        }
