...
class UpdateUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const USER_STATUS_ACTIVATE = 'Activate';
    public const USER_STATUS_DEACTIVATE = 'Deactivate';
    ...
    {
        return [
            self::USER_STATUS_ACTIVATE,
            self::USER_STATUS_DEACTIVATE,
        ];
    }
    ...
    */
    ...
    public function setUserId($user_id)
    {
        ...
        if ((mb_strlen($user_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling UpdateUser., must be bigger than or equal to 1.');
        }
    ...
    public function setUserStatus($user_status)
    {
        ...
        $allowedValues = $this->getUserStatusAllowableValues();
        if (!in_array($user_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'user_status', must be one of '%s'",
                    $user_status,
     ...
     * Sets to_user_id
     *
     * @param string|null $to_user_id to_user_id
     *
     * @return self
     */
    public function setToUserId($to_user_id)
    {
        if (is_null($to_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'to_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
