    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\BoldSign\Model\\' . $data->{$discriminator};
    ...
    */
    ...
    public static function getFormParams(ModelInterface $model): array
    {
        ...
        foreach ($model::attributeMap() as $key => $_) {
            ...
            $true_key = $model::attributeMap()[$key];
            ...
            if (strpos($apiTypes[$key], 'SplFileObject') !== false) {
                ...
                if (strpos($apiTypes[$key], 'SplFileObject[]') !== false) {
                    ...
                    foreach ($value as $file) {
                        ...
                        $filesList[] = Utils::tryFopen(
                            ObjectSerializer::toFormValue($file),
                            'rb'
                        );
                    }
                    $formParams[$true_key] = $filesList;
            ...
            if (strpos($apiTypes[$key], 'array') !== false || is_array($value)) {
                ...
                foreach ($value as $arrayValue) {
                    $listValues[] = is_scalar($arrayValue)
                        ? ObjectSerializer::toFormValue($arrayValue)
                        : GuzzleHttp\Utils::jsonEncode(
                            ObjectSerializer::sanitizeForSerialization($arrayValue)
                        );
                }
